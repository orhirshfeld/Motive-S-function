...
#define test1_rtModel                  RT_MODEL_test1_T
...
typedef struct {
  ...
  real_T SFunction_o7;                 /* '<Root>/S-Function' */
} B_test1_T;
...
#define rtB                            test1_B
#define BlockIO                        B_test1_T
#define rtP                            test1_P
#define Parameters                     P_test1_T
#define rtDWork                        test1_DW
#define D_Work                         DW_test1_T
...
extern "C" {
  ...
  extern void test1_output(void);
  extern void test1_update(void);
